...
\item<2-> We bound the arm-elimination probability by Bernstein inequality (as in \cite{audibert2009exploration}) rather that the Chernoff-Hoeffding bounds (used in UCB-Imp). 
